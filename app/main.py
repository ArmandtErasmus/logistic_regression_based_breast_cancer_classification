...
def sidebar():
    ...
    with st.sidebar:
        st.header('Cell Nuclei Parameters')
...
def add_predictions(input_data):
    ...
    st.write("Note that this is simply a prediction.")
...
def main():
    ...
    with st.container():
        st.title('Logistic Regression Based Breast Cancer Prediction')
        
    col1, col2 = st.columns([2, 1], gap = 'large', border = True)
